...
class IncidenciaSuccessViewController: UIViewController {
    ...
    @IBAction func iniciAction(_ sender: Any) {
    ...
    override func viewDidLoad() {
        ...
        doneButton.setTitle(NSLocalizedString("Tornar al inici", comment: "Tornar al inici"), for: .normal)
        
        indicatorLabel.text = NSLocalizedString("Gràcies pel teu avís, la incidència s'ha registrat correctament.", comment: "Gràcies pel teu avís, la incidència s'ha registrat correctament.")
